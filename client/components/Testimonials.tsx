...
export default function Testimonials() {
  ...
  return (
    <section className="grid-container bg-testimonialBG bg-no-repeat bg-right pt-20 pb-10">
      <main className="col-start-2 col-end-3">
        ...
        <div className="flex-row md:flex mt-10 md:mt-20 ">
          {testimonials.map(({ name, img, company, text, id }) => (
            <div className=" bg-gradient-to-tr from-purple-300 to-red-200 max-w-sm rounded-3xl transform cursor-pointer mb-4">
